...
import com.donkee.house.dao.impl.Zsrall2DaoImpl;
...
public class Zsrall2Controller extends HttpServlet {
	...
	private IZsrall2Dao zsrall2Dao = new Zsrall2DaoImpl();
	...
	protected void list(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		PageInfo<Zsrall2> pageInfo = zsrall2Dao.findByPage(pageNum,3);
